            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="p-10 bg-orange-200">
                        <form method="post" action="{{ route('houses-rent.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-12 gap-6 py-5 px-1">
                                ...
                                <div class="sm:col-span-2">
                                    <select name="heating"
                                            class="border rounded-lg px-3 border text-gray-500 text-gray-500 border-gray-400 py-2 mt-1 mb-2 text-sm w-full outline-none focus:shadow-outline">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-12 gap-6 py-5 px-1">
                                ...
                                <div class="sm:col-span-2">
                                    <select name="water_connection"
                                        ...
                                        <option value="Rurociąg">Rurociąg</option>
