                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <ul class="">
                                    ...
                                    <li id="navi-2" class="leading-7 text-sm font-medium">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-900 h-5 w-5;" viewBox="0 0 20 20"
                                    ...
                                    <li id="navi-2" class="leading-7 text-sm font-medium">
                                        ...
                                        <a href="mailto:biuro@domiwa.nieruchomosci.pl" class="text-gray-900 hover:text-gray-500 text-small underline">
                                            biuro@domiwa.nieruchomosci.pl
                                        </a>
                                    </li>
                                    <li id="navi-2" class="leading-7 text-sm font-medium">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" style="display: inline-block">
